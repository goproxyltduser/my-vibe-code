    ...
    const TabSupport = () => {
        ...
        const handleSendMessage = async () => {
            ...
            try {
                ...
                if (res.ok) {
                    alert("Сообщение отправлено! Мы ответим на вашу почту.");
                    setMessage('');
                } else {
            ...
            <div>
                ...
                <div className="bg-white p-8 rounded-xl shadow-sm border border-gray-200 max-w-2xl">
                    <div className="flex items-start gap-4 mb-6">
                        ...
                        <div>
                            ...
                            <p className="text-sm text-gray-500">
                                Опишите проблему, и мы пришлем решение на вашу почту <b>{user.email}</b>.
                                Также вы можете написать нам в <a href="https://t.me/maxim_hayd" target="_blank" className="text-[#E85D04] underline font-bold">Telegram</a>.
                            </p>
                        </div>
                    </div>
                    ...
                    <textarea
                        ...
                        className="w-full h-40 p-4 bg-gray-50 border border-gray-200 rounded-xl outline-none focus:border-[#E85D04] mb-4 resize-none"
                    />

                    <button
                        onClick={handleSendMessage}
                        disabled={isSending}
                        className="px-8 py-3 bg-black text-white font-bold rounded-xl hover:bg-gray-800 transition shadow-lg disabled:opacity-50 flex items-center gap-2"
                    >
                        {isSending ? 'Отправка...' : (
                            <>
            ...
            <aside className="w-full md:w-64 bg-[#181818] text-white flex-shrink-0 md:min-h-screen">
                ...
                <nav className="p-4 space-y-2">
                    ...
                    <Link
                        ...
                        className="flex items-center gap-3 w-full px-4 py-3 rounded-xl transition-all font-bold text-gray-400 hover:bg-gray-800 hover:text-white group"
                    >
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="w-5 h-5 text-[#E85D04] group-hover:text-white transition-colors">
               ...
               {/* 5. ПОДДЕРЖКА (СЛЕВА ВНИЗУ) */}
                <div className="mt-auto px-4 pb-2">
                    <button
                        onClick={() => setActiveTab('support')}
                        className={`flex items-center gap-3 w-full px-4 py-3 rounded-xl transition-all font-bold ${activeTab === 'support' ? 'bg-[#E85D04] text-white shadow-lg shadow-[#E85D04]/20' : 'text-gray-400 hover:bg-gray-800 hover:text-white'}`}
                    >
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className={`w-5 h-5 ${activeTab === 'support' ? 'text-white' : 'text-[#E85D04]'}`}>
